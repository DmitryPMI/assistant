...
def test_load_json():
	ai = Assistant()
	test_data = {"279501304": {"tasks": {"0": {"name": "\u0421\u043e\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u0437\u0430\u0434\u0430\u0447\u0438", "description": "\u0421\u043a\u043e\u043b\u044c\u043a\u043e \u0437\u0430\u0434\u0430\u0447 \u0441\u043e\u0441\u0442\u0430\u0432\u0438\u043b?", "status": 0}, "1": {"name": "\u041e\u0442\u043b\u0430\u0434\u0438\u0442\u044c \u043a\u043e\u0434", "description": "\u041a\u0430\u043a \u0442\u0430\u043c \u0441 \u043a\u043e\u0434\u043e\u043c?", "status": 1}, "2": {"name": "\u0421\u0434\u0435\u043b\u0430\u0442\u044c workflow", "description": "\u0421\u043a\u043e\u043b\u044c\u043a\u043e \u0442\u0435\u0441\u0442\u043e\u0432 \u0434\u043e\u0431\u0430\u0432\u0438\u043b?", "status": 0}, "3": {"name": "123", "description": "123", "status": 1}, "4": {"name": "123", "description": "123", "status": 0}, "5": {"name": "1233123", "description": "123131231", "status": 0}}, "tomatoes": {"0": {"task_id": "0", "answer": "\u042f \u043f\u044b\u0442\u0430\u043b\u0441\u044f", "ts": "03/15/2021, 12:03:57", "status": "1", "time_tomato": 1}}}}
	with open('1.json', 'w') as file:
		json.dump(test_data, file)
	ai.load_from_json('1.json')
	assert "279501304" in ai.users
	assert ai.users["279501304"].tasks[test_data["279501304"]["tasks"]["0"]["name"]].description == test_data["279501304"]["tasks"]["0"]["description"]
	os.remove('1.json')
